        ...
        public void onClick(View view) {
            ...
            if (id == R.id.beginPublish) {
                if (getPushConfig() != null) {
                    //LivePush.startActivity(PushConfigActivity.this, mAlivcLivePushConfig, mUrl.getText().toString(), mAsyncValue, mAudioOnlyPush, mOrientationEnum, mCameraId, isFlash);
                }
                return;
