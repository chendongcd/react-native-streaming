...
public class StorageContextPush extends ReactContextBaseJavaModule {

    final BroadcastReceiver receiver;

    static ThemedReactContext mContext;

    static StorageContextPush instance = null;

    static ViewGroup vp;

    static View view;
    public StorageContextPush(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public static void setInstance (StorageContextPush demo) {
        if(instance == null) {
            instance = demo;
        }else {
            return;
    ...
    public static StorageContextPush getInstance() {
        return instance;
    }
